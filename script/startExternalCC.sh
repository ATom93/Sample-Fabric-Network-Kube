...
kubectl run org1-peer1-basic --image=chaincode/basic --image-pull-policy=Never --env "CHAINCODE_SERVER_ADDRESS=0.0.0.0:30751" --env "CORE_PEER_ADDRESS=peer1-org1-com:30751" --env "CHAINCODE_AS_A_SERVICE_BUILDER_CONFIG=\"{\"peername\":\"org1-peer1\"}\"" --env "CORE_CHAINCODE_ID_NAME=$PACKAGE_ID_1" --env "DEBUG=true" --port 30751
kubectl run org2-peer1-basic --image=chaincode/basic --image-pull-policy=Never --env "CHAINCODE_SERVER_ADDRESS=0.0.0.0:30751" --env "CORE_PEER_ADDRESS=peer1-org2-com:30756" --env "CHAINCODE_AS_A_SERVICE_BUILDER_CONFIG=\"{\"peername\":\"org2-peer1\"}\"" --env "CORE_CHAINCODE_ID_NAME=$PACKAGE_ID_2" --env "DEBUG=true" --port 30751
